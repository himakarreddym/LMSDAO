...
public class GenreDAO extends BaseDAO {
	...
	public void saveGenre(Genre Genre) throws SQLException {
		save("INSERT INTO tbl_genre (genre_id) VALUES (?)", new Object[] { Genre.getGenreName() });
	}
	...
	public Integer saveGenreWithID(Genre Genre) throws SQLException {
		return saveWithID("INSERT INTO tbl_genre (GenreName) VALUES (?)", new Object[] { Genre.getGenreName() });
	}
