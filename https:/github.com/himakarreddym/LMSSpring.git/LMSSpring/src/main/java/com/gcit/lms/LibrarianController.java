...
public class LibrarianController {
	...
	public ModelAndView gottoLibrarian(Locale locale, Model model,@RequestParam(value ="branchId",required=false) Integer branchId) {
		if(branchId == null) {
			branchId = 1;
		}
		...
		return new ModelAndView("librarian", "Branch", Branch);
	}
